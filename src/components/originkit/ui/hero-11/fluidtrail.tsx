...
void main() {
    ...
    if (v_uv.x > 1.0 - u_texel.x)
        R = -C.x;

    if (v_uv.y < u_texel.y)
        B = -C.y;

    if (v_uv.y > 1.0 - u_texel.y)
        T = -C.y;
 ...
 */
export default function FluidSim(props: any) {
    props = {
        ...COMPONENT_DEFAULTS,
        ...props,
    }
    ...
    useEffect(() => {
        ...
        // Depois desta verificação, o TypeScript sabe
        // que canvasElement nunca é null.
        ...
        let velocity:
            ReturnType<typeof createDoubleFBO>
        ...
        function updatePointer(
            ...
            pointer.moved =
                Math.abs(pointer.dx) > 0 ||
                Math.abs(pointer.dy) > 0
        }
